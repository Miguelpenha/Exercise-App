...
async function submit(navigation: NativeStackScreenProps<Inavigation, 'AddExercises'>['navigation'], treinos: Itreino[], name: string, séries: number, quantity: number, icon: keyof typeof MaterialIcons.glyphMap) {
